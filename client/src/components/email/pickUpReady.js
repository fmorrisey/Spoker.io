    ...
    return (
      <div>
        ...
        <div>
          ...
          <p>
            Thank you ${this.props.auth.user.first_name} for your purchase of:
          </p>
        </div>
        ...
        <div>
          <p>
            <u>ADDRESSS</u>
            <br />${this.props.auth.user.first_name} $
            {this.props.auth.user.last_name}
            <br />${this.state.address.street1}
            <br />${this.state.address.street2}
            <br />${this.state.address.city}
            <br />${this.state.address.state}
            <br />${this.state.address.country}
            <br />${this.state.address.zipCode}
          </p>
        </div>
        `
      </div>
